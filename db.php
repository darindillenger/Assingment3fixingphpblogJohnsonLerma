...
function add_event_log($action) {
  ...
  delete_article($aid);
  add_event_log("Deleted article $aid successfylly ");
...
function add_user($username, $role, $password, $ga_secret) {

	$password = password_hash($password, PASSWORD_DEFAULT);
	$query="
		INSERT INTO
		authors
		(username, role, password, ga_secret)
		VALUES
		(?,?,?,?)";
	return run_query ($query, [$username, $role, $password, $ga_secret]);
}
